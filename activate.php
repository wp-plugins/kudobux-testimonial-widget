...
if (isset($_POST['kudobuzz_uid']) && $_POST['kudobuzz_uid'] != "") {
    ...
    window.alert('Hurray your account is activated. You will be redirected to the instructions page to start adding your kudos')
    window.location='./admin.php?page=Kudobuzz';
    </SCRIPT>");
    }else{
...
<div class="icon32" id="icon-options-general"></div>
 <h2>Kudobuzz Testimonial Widget - Account Activation</h2> 
	...
	padding:10px 0px;">
    <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><img src="<?php echo plugins_url().'/kudobux-testimonial-widget/assets/img/kudo_head.png' ?>" width="113" height="65" alt="Kudobuzz Testimonial Widget" />
...
height: 420px;"> 
    <form name="kudobuzz_form" method="post" action="<?php echo str_replace('%7E', '~', $_SERVER['REQUEST_URI']); ?>">
        ...
        <?php echo "<h4 style='text-align: center;font-size: 20px;'>" . __('Paste confirmation code here and click on the activate button', 'kudobuzz_conf') . "</h4>"; ?>
        ...
        <p class="submit" style="text-align: center;">
            <input type="submit" name="Submit" id="activate_btn" value="<?php _e('Activate', 'kudobuzz_conf') ?>" />
        </p>
    </form></div>
